...
pub mod env {
    ...
    ///
    /**
       InputUnit1D::cursor_key(); //
       InputUnit2D::cursor_current_axis(); //
       InputUnit1D::build(InputKey1D::_A).build_value(InputValue1D::DOWM); //
       InputUnit1D::build(InputKey1D::_A).build_value(InputValue1D::DOWM); //
    */
    // 输入单元 用于检测单次输入
    #[derive(Clone, Copy, Default, Debug)]
        ...
        pub fn cursor_key() -> Option<Self> {
            unsafe {
                ...
                if super::CURSOR_LEFT_UP != false {
                    unsafe { super::CURSOR_LEFT_UP = false };
                    return Some(
                        InputUnit1D::build(InputKey1D::MOUSE_LEFT_BUTTON)
                ...
                if super::CURSOR_RIGHT_UP != false {
                    unsafe { super::CURSOR_RIGHT_UP = false };
                    return Some(
                        InputUnit1D::build(InputKey1D::MOUSE_RIGHT_BUTTON)
                            .build_value(InputValue1D::UP),
                    );
                ...
                if super::CURSOR_MID_UP != false {
                    unsafe { super::CURSOR_MID_UP = false };
                    return Some(
                        InputUnit1D::build(InputKey1D::MOUSE_MID_BUTTON)
                            .build_value(InputValue1D::UP),
                    );
    ...
    impl InputUnit2D {
        ...
        pub fn cursor_current_axis() -> Self {
            return unsafe { Self::build(InputKey2D::CURSOR_AXIS).build_value(super::CURSOR_AXIS)};
        }

        pub fn cursor_last_axis() -> Self {
            return unsafe { Self::build(InputKey2D::CURSOR_AXIS).build_value(super::CURSOR_LAST_AXIS) };
        }

        pub fn cursor_speed() -> Self {
            let _r;
            unsafe {
                _r = super::CURSOR_AXIS - super::CURSOR_LAST_AXIS;
                super::CURSOR_LAST_AXIS = super::CURSOR_AXIS;
            };
            return unsafe { Self::build(InputKey2D::CURSOR_AXIS).build_value(_r) };
        }
    }
