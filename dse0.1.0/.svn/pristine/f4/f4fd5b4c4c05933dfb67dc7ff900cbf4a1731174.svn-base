...
cargo objdump OPTIONS:   
  ...
  --archive-headers       Display archive header information-a      Alias for --archive-headers     
  ...
  --help  Display available options (--help-hidden for more)-h      Alias for --section-headers     
    - <value>              Alias for --section             
  ...
  --mcpu=cpu-name         Target a specific cpu type (--mcpu=help for details)            
    -llvm <arg>            Specify an argument to forward to LLVM's CommandLine library    
    - <value>              Alias for --disassembler-options= -m      Alias for --macho               
  ...
  --sourceWhen disassembling, display source interleaved with the disassembly. Implies --disassemble      
  ...
  --syms  Display the symbol table        
    -      Alias for --source-s      Alias for --full-contents       
  ...
  --x86-asm-syntax=intel  Emit Intel-style disassembly    
    ...
    -      Alias for --disassemble-zeroes            llvm-objdump MachO Specific Options:      
