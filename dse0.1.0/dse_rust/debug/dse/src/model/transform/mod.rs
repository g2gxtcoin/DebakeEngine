...
pub mod env {
    ...
    impl TransformD {
        pub fn update_global(
            ...
            let mut _parent= datum_in.vec_ref()[parent_index_in as  usize].as_ref().unwrap().global_clone();
            let mut _self=datum_in.vec_mut()[self_index_in as  usize].as_mut().unwrap();
