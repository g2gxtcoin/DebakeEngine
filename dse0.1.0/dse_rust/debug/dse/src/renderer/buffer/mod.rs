...
pub mod env {
    use crate::renderer::cfg::env::{IMG2VIEW, IMG_FORMAT};
    use ash::vk;
        ...
        BufferT: Default,
    {
        ...
        pub fn usage_ref(&self) -> usize {
            return self.usage;
        }
        pub fn usage_mut(&mut self) -> usize {
            return self.usage;
        }
        pub fn buffer_mut(&mut self) -> &mut BufferT {
            &mut self.buffer
        }
        pub fn buffer_ref(&self) -> &BufferT {
            &self.buffer
        }
        pub fn device_mem_ref(&self) -> vk::DeviceMemory {
            self.device_mem
        }
        pub fn device_mem_mut(&mut self) -> &mut vk::DeviceMemory {
            &mut self.device_mem
        }
    }
}
